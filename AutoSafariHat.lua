...
local petTamersWithoutBattle = {}   -- List of pet tamers
        ...
        if validTamer then
            ...
            if event == "GOSSIP_SHOW" then
                ...
                elseif AutoSafariHatOptions.AutoQuestAccept and _G.GetGossipActiveQuests() and questindex then
                    ...
                    _G.CloseGossip()
                elseif AutoSafariHatOptions.TamerPetHat and GetGossipOptions() and not petTamersWithoutBattle[tamerID] then
...
do
    ...
    petTamers[79858] = true -- Serr'ah (Patch 6.0)
    petTamers[83837] = true
    petTamers[85418] = true -- Leo the Lioness (Patch 6.0)
    ...
    petTamers[90675] = true -- Erris the Collector (Patch 6.1)
    petTamers[91014] = true -- Erris the Collector (Patch 6.1)
    petTamers[91015] = true -- Erris the Collector (Patch 6.1)
    petTamers[91016] = true -- Erris the Collector (Patch 6.1)
    petTamers[91017] = true -- Erris the Collector (Patch 6.1)
    petTamers[91026] = true -- Kura Thunderhoof (Patch 6.1)
    petTamers[91361] = true -- Kura Thunderhoof (Patch 6.1)
    petTamers[91362] = true -- Kura Thunderhoof (Patch 6.1)
    petTamers[91363] = true -- Kura Thunderhoof (Patch 6.1)
    petTamers[91364] = true -- Kura Thunderhoof (Patch 6.1)

    petTamersWithoutBattle[79858] = true -- Serr'ah (Patch 6.0)
    petTamersWithoutBattle[85418] = true -- Leo the Lioness (Patch 6.0)
